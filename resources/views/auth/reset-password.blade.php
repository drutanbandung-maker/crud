      ...
      <form method="POST" action="{{ route('password.reset') }}" novalidate>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="password" name="password" class="form-control" placeholder="Min. 6 karakter" required autofocus>
          </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <button type="submit" class="btn btn-primary btn-submit" data-loading-text="Menyimpan...">Reset Password</button>
        </div>
      </form>
    </div>
  </div>
